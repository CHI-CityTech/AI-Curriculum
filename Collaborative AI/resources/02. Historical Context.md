...
This document expands upon some theoretical models that inform the Balanced Blended Space (BBS) framework, particularly focusing on the transition from traditional models of human-computer interaction to a symmetrical, collaborative AI paradigm. The following thinkers and their frameworks are pivotal in computational philosophy, help contextualizing and contrasting BBS philosophy.
...
**Suggested Reading:**
- Latour, Bruno. (2005). *Reassembling the Social: An Introduction to Actor-Network-Theory*. Oxford University Press. [Publisher's page](https://global.oup.com/academic/product/reassembling-the-social-9780199256051)
